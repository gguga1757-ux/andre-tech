...
function PremiumDevice() {
  ...
  return (
    <div
      className="pointer-events-none absolute top-1/2 right-[-30%] z-[2] flex w-[92vw] -translate-y-1/2 items-center justify-center opacity-[0.42] sm:right-[-22%] md:right-[-6%] md:w-[52vw] md:opacity-100"
      aria-hidden="true"
    >
      <motion.div
      ...
      >
        <motion.div
          ...
          className="absolute h-[44rem] w-[54rem] translate-x-10 translate-y-8 rounded-[45%] bg-[radial-gradient(ellipse,rgba(45,255,20,.105),rgba(148,255,135,.035)_46%,transparent_72%)] blur-[150px]"
        />
        <div className="absolute h-[32rem] w-[40rem] translate-x-8 translate-y-7 rounded-full bg-[radial-gradient(ellipse,rgba(45,255,20,.07),transparent_68%)] blur-[60px]" />
        <motion.div
          animate={
            shouldReduceMotion
              ? undefined
          ...
          className="absolute h-[36rem] w-[36rem] rounded-[42%] border border-primary/[0.055] bg-[conic-gradient(from_180deg,transparent,rgba(45,255,20,.06),transparent,rgba(255,255,255,.035),transparent)] blur-[0.2px]"
        />
        <motion.div
          animate={
            shouldReduceMotion
          ...
          className="absolute bottom-[12%] h-16 w-[20rem] rounded-full bg-[radial-gradient(ellipse,rgba(0,0,0,.74),rgba(45,255,20,.07)_48%,transparent_74%)] blur-[38px]"
        />
        ...
        >
          <div className="calibration-grid absolute -inset-[30%] z-0 opacity-[0.18]" />
          <div className="absolute -inset-[18%] z-0 rounded-[42%] border border-primary/[0.055] [transform:rotate(-8deg)]" />
          <div className="absolute -inset-[9%] z-0 rounded-[40%] border border-white/[0.035] [transform:rotate(11deg)]" />
          <motion.div
            animate={
              shouldReduceMotion
                ? undefined
            ...
            className="absolute -inset-[22%] z-0 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(45,255,20,.115),rgba(45,255,20,.04)_44%,transparent_72%)] blur-[72px]"
          />
          <img
            src={DEVICE_IMAGE}
            alt=""
            className="absolute inset-0 z-[1] h-full w-full object-contain opacity-[0.44] mix-blend-screen [filter:brightness(0)_saturate(100%)_invert(77%)_sepia(95%)_saturate(1470%)_hue-rotate(54deg)_blur(9px)]"
            draggable={false}
          />
          <img
            src={DEVICE_IMAGE}
            alt=""
            className="absolute inset-0 z-[11] h-full w-full object-contain opacity-[0.28] mix-blend-screen [clip-path:polygon(58%_0,100%_0,100%_100%,72%_100%)] [filter:brightness(1.75)_contrast(1.08)_saturate(1.1)]"
            draggable={false}
          />
          <img
            src={DEVICE_IMAGE}
            alt=""
            className="absolute inset-0 z-[11] h-full w-full object-contain opacity-[0.16] mix-blend-screen [clip-path:polygon(0_0,18%_0,11%_100%,0_100%)] [filter:brightness(1.45)_contrast(1.05)_saturate(1.05)]"
            draggable={false}
          />
          ...
          <img
            src={DEVICE_IMAGE}
            alt=""
            className="relative z-10 max-h-[58vh] w-auto max-w-[min(380px,60vw)] object-contain"
            style={{
              filter:
...
export function Hero() {
  return (
    <section className="relative min-h-[92vh] overflow-hidden noise">
      ...
      <div className="relative z-10 flex min-h-[92vh] items-center">
        <div className="mx-auto w-full max-w-[var(--max)] px-[var(--gutter)] pb-16 pt-32 md:pb-20">
          <motion.div
          ...
          >
            ...
            <motion.div
              ...
              className="mt-11 grid max-w-[760px] gap-3 sm:grid-cols-3"
            >
